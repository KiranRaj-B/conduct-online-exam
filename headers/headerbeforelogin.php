    ...
    <nav class="navbar navbar-expand-xl sticky-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                <ul class="navbar-nav">
                    <a href="../home/index.php" class=""><button type="button" class="btn">Home</button></a>
                    <a href="../home/aboutus.php" class=""><button type="button" class="btn">About Us</button></a>
                    <li class="nav-item dropdown">
                        <button type="button" class="btn btn-normal dropdown-toggle" data-bs-toggle="dropdown">Tutorials</button>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../tutorials/htmlcss.php">HTML and CSS</a></li>
                            <li><a class="dropdown-item" href="../tutorials/java.php">Java</a></li>
                            <li><a class="dropdown-item" href="../tutorials/python.php">Python</a></li>
                            <li><a class="dropdown-item" href="../tutorials/sql.php">SQL</a></li>
                            <li><a class="dropdown-item" href="../tutorials/php.php">PHP</a></li>
                            <li><a class="dropdown-item" href="../tutorials/bootstarp.php">BOOTSTRAP</a></li>
                        </ul>
                    </li>
                    <a href="../home/contact_us.php" class=""><button type="button" class="btn">Contact Us</button></a>
                    <!-- <a href="../home/logout" class="logout"><button type="button" class="btn logout">Logout <i class="fa fa-sign-out"></i></button></a> -->
                  </ul>
                <div class="ms-auto">
