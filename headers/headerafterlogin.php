    ...
    <nav class="navbar navbar-expand-xl sticky-top">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="mynavbar">
                <ul class="navbar-nav">
                    <a href="../Admin/index.php" class=""><button type="button" class="btn">Home</button></a>
                    <!-- <a href="../Admin/aboutus.php" class=""><button type="button" class="btn">About Us</button></a> -->
                    <li class="nav-item dropdown">
                        <button type="button" class="btn btn-normal dropdown-toggle" data-bs-toggle="dropdown">Online Test</button>
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="../Admin/add_test.php">Add New Test</a></li>
                          <li><a class="dropdown-item" href="../Admin/test_revise.php">Revise Test</a></li>
                          <li><a class="dropdown-item" href="../Admin/test_master.php">Test Master</a></li>
                        </ul>
                    </li>
                    <!-- <li class="nav-item dropdown">
                     <button type="button" class="btn btn-normal dropdown-toggle" data-bs-toggle="dropdown">Question Papers</button>
                      <ul class="dropdown-menu">
                        <li><a class="dropdown-item" href="#">Add New QP</a></li>
                        <li><a class="dropdown-item" href="#">Revise QP</a></li>
                        <li><a class="dropdown-item" href="#">QP Master</a></li>
                      </ul>
                    </li> -->
                    <!-- <a href="../home/index.php" class=""><button type="button" class="btn">Contact Us</button></a> -->
                    <a href="../home/logout.php" class="logout"><button type="button" class="btn logout">Admin Logout <i class="fa fa-sign-out"></i></button></a>
                  </ul>
            </div>
        </div>
    </nav>
