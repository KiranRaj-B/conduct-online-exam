...
<br>
      ...
      <div style="text-align: center; margin-top: 40px;">
        ...
        <p style="font-size: 40px;">Have you learned Bootstrap? Then </p>
        <button type="submit" class="btn btn-primary btn-lg" style="font-size: 30px;" name="submit">Take an Exam</button>
      </div>
      </form>
      <br>
    <?php   if (isset($_POST['submit'])) { echo "<script>window.location='../User/choose_test?course=BOOTSTRAP';</script>"; } ?>
